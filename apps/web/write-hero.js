    ...
    >
      ...
      >
        ...
        >
          ...
          advisory for everyone from solo founders to scaling enterprises. No
          retainers. No surprises.
        </p>
        ...
        >
          ...
          <a
            ...
            style={{
              ...
              color: hoveredSecondary ? 'var(--ink)' : 'var(--ink-soft)',
              padding: '0.9rem 1.85rem',
              borderRadius: '4px',
              textDecoration: 'none',
              fontWeight: 500,
              fontSize: '0.875rem',
              transition: 'all 0.2s',
              background: hoveredSecondary ? 'var(--paper-warm)' : 'transparent',
            }}
          ...
          >
            ...
            <a
              ...
              style={{
                ...
                height: '30px',
                borderRadius: '6px',
                background: hoveredLI
                  ? 'rgba(10,102,194,0.3)'
                  : 'rgba(255,255,255,0.06)',
                border: hoveredLI
                  ? '1px solid rgba(10,102,194,0.6)'
          ...
          {stats.map((s) => (
            <div
              ...
              style={{
                ...
                cursor: 'default',
                transform:
                  hoveredStat === s.id ? 'translateY(-2px)' : 'translateY(0)',
                boxShadow:
                  hoveredStat === s.id ? '0 8px 24px rgba(0,0,0,0.2)' : 'none',
                transition: 'all 0.2s',
              }}
            >
              <div
                style={{
                  ...
                  fontWeight: 900,
                  color:
                    hoveredStat === s.id ? 'var(--gold-light)' : 'var(--white)',
                  lineHeight: 1,
...
const outPath = path.join(__dirname, 'src', 'app', 'components', 'homepage', 'Hero.tsx');
fs.writeFileSync(outPath, content, 'utf8');
console.log('Hero.tsx written successfully to', outPath);